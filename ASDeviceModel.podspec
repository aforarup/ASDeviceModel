...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ASDeviceModel.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Arup Saha/ASDeviceModel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Arup Saha' => 'arups@zeta.tech' }
  s.source           = { :git => 'https://github.com/Arup Saha/ASDeviceModel.git', :tag => s.version.to_s }
